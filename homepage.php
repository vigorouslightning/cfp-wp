...
<div class="content" id="second">
    <div class="container">
        <div class="card-wrapper row">
            <div class="col-md-6">
                <div class="card">
                    <h3 class="card-header">Featured<span class="fi flaticon-presentation pull-xs-right"></span></h3>
            ...
            <div class="col-md-6">
                <div class="card">
                    <h3 class="card-header">Featured<span class="fi flaticon-handshake pull-xs-right"></span></h3>
                    <div class="card-block">
                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                        <a href="#" class="cfp-link">Go somewhere&nbsp;&gt;</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
